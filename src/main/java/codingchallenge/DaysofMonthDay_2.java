...
public class DaysofMonthDay_2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter the number:");
		    ...
		    case 2:{
		    	System.out.println("The 2st month of the year is February ");
			...
			case 5:{
				System.out.println("The 4th month of the year is May ");
				System.out.println("Number of days in the month of May is 31 ");
				break;
				
			}
			case 6:{
				System.out.println("The 5th month of the year is June ");
				System.out.println("Number of days in the month of June is 30 ");
				break;
				
			 }	
			case 7:{
				System.out.println("The 6th month of the year is July");
				System.out.println("Number of days in the month of July is 31 ");
				break;
				
			 }	
			case 8:{
				System.out.println("The 7th month of the year is  August");
